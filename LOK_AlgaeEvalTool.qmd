...
This interactive tool allows users to evaluate model predictions presented by Julian et al. (2025). The application features three different modeling approaches.
