...
This interactive tool provides an intereactive tool to evaluate model predctions presented by Julian et al. (2025). In this application, three modeling approaches are presented.
...
```{r}
#| label: walker2020-Eq
#| tbl-cap: Regression equation for mean summer chlorophyll-a and bloom frequenceis as reported by Walker (2020)
...
This interactive section allows the user to explore the existing predictions of existing models (explained above) for the water management and restoration scenarios presented in Julian et al. (2025). 
<br>
